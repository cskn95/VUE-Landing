<template>
  <!--<ParticlesBg
    ...
    refresh
  />-->
  <section :key="1" class="flex flex-col bg-[url('/bg3.jpg')] justify-center bg-cover bg-center h-screen">
    <!-- <AppHeader /> -->
  ...
  <section :key="2" class="flex flex-col bg-purple-500 h-screen">
    <AppHeader />
    <Hero />
  </section>
</template>
